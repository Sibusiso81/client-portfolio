...
import { ChevronRight, Briefcase, GraduationCap, Code, Shield, CastleIcon as ChessKnight} from "lucide-react"
...
const academicBackground = [
  { name: "BCom (Honours) in Information Management – University of Johannesburg (2024)", icon: GraduationCap },
  { name: "BA in Public Management & Governance – University of Johannesburg (2021-2023)", icon: GraduationCap },
  { name: "4IR Certificate (University of Johannesburg)", icon: GraduationCap },
  { name: "Introduction to Data Analytics with Python (Alison.com)", icon: GraduationCap },
  ...
  return (
    ...
    <div className="grid grid-cols-2 md:text-lg lg:text-2xl gap-6">
      ...
      <div className="space-y-4 col-span-2 lg:col-span-1">
        ...
        <h2 className="text-xl text-[#eaeaea]/80">Business Automation Analyst | CyberSecurity Enthusiast </h2>
      </div>
      ...
      <div className="col-span-2 lg:col-span-1 lg:p-6 text-sm">
        ...
        >
          ...
          <Button
            ...
            className={cn(
              ...
              activeView === "overview" ? "bg-[#393E41] text-[#eaeaea]" : "bg-[#ececec] text-black",
          ...
          <Button
            ...
            className={cn(
              "rounded-md transition-colors duration-200 shadow-none",
              activeView === "skills" ? "bg-[#393E41] text-[#eaeaea]" : "bg-[#ececec] text-black",
              "hover:bg-[#393E41] hover:text-[#eaeaea]",
            )}
          >
            Skills
          ...
          <Button
            ...
            className={cn(
              "rounded-md transition-colors duration-200 shadow-none",
              activeView === "academic" ? "bg-[#393E41] text-[#eaeaea]" : "bg-[#ececec] text-black",
              "hover:bg-[#393E41] hover:text-[#eaeaea]",
            )}
          >
            Academic
          ...
          <Button
            ...
            className={cn(
              "rounded-md transition-colors duration-200 shadow-none",
              activeView === "interests" ? "bg-[#393E41] text-[#eaeaea]" : "bg-[#ececec] text-black",
              "hover:bg-[#393E41] hover:text-[#eaeaea]",
            )}
          >
            Interests
        ...
        {activeView === "overview" && (
          ...
          >
            <p className="text-lg leading-relaxed text-[#eaeaea]/90">
              ...
              inefficiencies, and create seamless workflows that help businesses operate at their best.
            </p>
          </motion.div>
        )}
        ...
        {activeView === "skills" && (
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-sm font-medium uppercase tracking-wider text-[#eaeaea]/70">Core Competencies</h3>
        ...
        {activeView === "academic" && (
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-sm font-medium uppercase tracking-wider text-[#eaeaea]/70">Academic Background</h3>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h4 className="font-medium">Chess & Strategic Thinking</h4>
                  <p className="text-sm text-[#eaeaea]/80">
                    Playing competitive chess since 2015, applying strategic thinking to business challenges.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h4 className="font-medium">Cybersecurity Enthusiast</h4>
                  <p className="text-sm text-[#eaeaea]/80">
                    Exploring ethical hacking and automation security, participating in platforms like TryHackMe.
                  </p>
                </div>
              </div>
            </div>
