...
export default function Home() {
  ...
  return (
    ...
    <section className="jsutify-center items-center w-full flex-col  h-screen  flex flex-1 relative ">
      ...
      <section className="
   w-screen h-screen flex flex-col  mx-auto my-auto text-black dark:text-white mt-8 ">
   ...
   <div className="flex flex-col lg:flex-row-reverse overflow-auto ">
    ...
    <Link href={'#email'} className=" w-full lg:w-1/2 h-22  flex flex-row space-x-1 p-2 md:p-1 lg:place-self-end">
